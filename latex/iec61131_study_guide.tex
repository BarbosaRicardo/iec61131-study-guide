...
\begin{tikzpicture}[
  ...
  \node[below=0.4cm of prog, font=\small, text=gray] (prog-note)
  ...
  \node[below=0.4cm of fb, font=\small, text=gray] (fb-note)
  ...
  \node[below=0.4cm of fn, font=\small, text=gray] (fn-note)
