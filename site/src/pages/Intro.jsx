...
export default function Intro() {
  return (
    ...
    >
      ...
      <h2 className="text-xl font-bold text-blue-400 mt-8 mb-3">Structure of This Guide</h2>
      <p>
      ...
      <div className="rounded-2xl p-5 my-6" style={{ background: 'rgba(37,99,235,0.08)', border: '1px solid rgba(37,99,235,0.25)' }}>
        <p className="text-sm italic text-slate-300">"{ANALOGIES.intro.text}"</p>
        <p className="text-xs text-blue-400 mt-2">— {ANALOGIES.intro.author}</p>
      </div>

      <h2 className="text-xl font-bold text-blue-400 mt-8 mb-3">Historical Context</h2>
      <p>
