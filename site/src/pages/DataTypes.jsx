...
export default function DataTypes() {
  return (
    ...
    >
      ...
      <h2 className="text-xl font-bold text-blue-400 mt-8 mb-3">Elementary Data Types</h2>
      ...
      <h2 className="text-xl font-bold text-blue-400 mt-8 mb-3">Variable Declaration Sections</h2>
      <p>
...
END_VAR`}</pre>
      ...
      <h2 className="text-xl font-bold text-blue-400 mt-8 mb-3">VAR_GLOBAL and Global Variable Lists</h2>
      <p>
...
END_VAR`}</pre>
      ...
      <h2 className="text-xl font-bold text-blue-400 mt-8 mb-3">Type Conversion Functions</h2>
      <p>
