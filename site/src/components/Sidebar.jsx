...
import { Menu, X, Zap, BookOpen, BarChart2, Home, Binary, Code, GitBranch, Share2, GitGraph, Package, Wrench, FlaskConical, CreditCard, LayoutGrid, LogIn, LogOut , FileText } from 'lucide-react'
      ...
      <div className="p-4 space-y-3" style={{ borderTop: '1px solid rgba(59,130,246,0.12)' }}>
        ...
        {!sessionLoading && (session ? (
          <div className="flex items-center justify-between gap-2 px-1">
            <span className="text-xs truncate" style={{ color: 'rgba(59,130,246,0.5)' }}>{session.user.email}</span>
            <button onClick={() => supabase.auth.signOut()} title="Sign out" style={{ color: 'rgba(59,130,246,0.5)' }} className="hover:text-rose-400 transition flex-shrink-0">
              <LogOut size={13} />
            </button>
          </div>
        ) : (
