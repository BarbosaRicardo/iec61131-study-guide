...
import { CheckCircle2, Circle, Menu, X, Cpu } from 'lucide-react'
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-5 border-b border-slate-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-navy-700 leading-tight">IEC 61131-3</div>
      ...
      <div className="p-4 border-t border-slate-100 space-y-3">
        <a
          href={`${import.meta.env.BASE_URL}iec61131_study_guide.pdf`}
          target="_blank"
        ...
        <p className="text-xs text-slate-400 text-center leading-relaxed">
          Power System RTAC Engineering<br />
          <span className="text-mblue-400">IEC 61131-3 Programming · 2026</span>
        </p>
      </div>
    </div>
  )
