...
import { Menu, X, Zap, BookOpen, BarChart2, Home, Binary, Code, GitBranch, Share2, GitGraph, Package, Wrench, FlaskConical, CreditCard } from 'lucide-react'
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 space-y-2" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        <p className="text-xs text-slate-600 text-center">
          SCADA Automation Engineering · IEC 61131-3 · May 2026
        </p>
      </div>
    </div>
  )
