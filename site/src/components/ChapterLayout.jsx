...
import { ChevronLeft, ChevronRight, BookOpen, Home, Binary, Code, GitBranch, Share2, GitGraph, Package, Zap, Wrench, FlaskConical, CreditCard } from 'lucide-react'
...
export default function ChapterLayout({ chapterId, title, children, prev, next }) {
  ...
  return (
    ...
    >
      {/* Chapter header */}
      <div className="mb-8">
        <div className="flex items-center gap-2 text-sm font-medium mb-3" style={{ color: 'rgba(59,130,246,0.75)' }}>
        ...
        <div className="mt-4 h-px" style={{ background: 'linear-gradient(90deg, rgba(59,130,246,0.8), rgba(29,78,216,0.4), transparent)' }} />
      </div>
