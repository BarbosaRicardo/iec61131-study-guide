...
import { Lightbulb, RefreshCw, Archive, AlertOctagon, DollarSign, Clock, HardDrive, Hash, Globe, Scissors, Package } from 'lucide-react'
import { FUN_FACTS } from '../data/chapters'

const ICON_MAP = {
  Archive, AlertOctagon, DollarSign, Clock, RefreshCw, HardDrive, Hash, Globe, Scissors, Package,
}
