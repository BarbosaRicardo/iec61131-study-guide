...
const STORAGE_KEY = 'iec61131_progress_v1'
const PROGRESS_EVENT = 'iec61131_progress_update'
...
export function useProgress() {
  ...
  const overallProgress = () => {
    const chapters = ['intro', 'datatypes', 'st', 'ld', 'fbd', 'sfc', 'pou', 'rtac', 'troubleshoot', 'lab']
